...
{
    public class ArmyBaseDBInitializer : DropCreateDatabaseAlways<ArmyBaseContext>
    {
        protected override void Seed(ArmyBaseContext db)
        {
            base.Seed(db);
            ...
            Employees.Add(new Employee() { Id = 3, NationalId = 10, FirstName = "Miroslav", LastName = "Klose", IsBarrackManager = false, IsTeamLeader = false, Salary = 1950.99, SpecializationId = 3, DateOfEmployment = DateTime.Now, RankId = 2, TeamId = 3, BarrackId = 2 });
            Employees.Add(new Employee() { Id = 4, NationalId = 2, FirstName = "Jon ", LastName = "Doe", IsBarrackManager = false, IsTeamLeader = false, Salary = 5000.00, SpecializationId = 1, DateOfEmployment = DateTime.Now, RankId = 5, TeamId = 2, BarrackId = 4 });
            Employees.Add(new Employee() { Id = 5, NationalId = 7, FirstName = "Jack", LastName = "Sparrow", IsBarrackManager = false, IsTeamLeader = false, Salary = 3500.50, SpecializationId = 4, DateOfEmployment = DateTime.Now, RankId = 3, TeamId = 1, BarrackId = 4 });
            ...
            Missions.Add(new Mission() { Id = 1, Name = "Mission one", Description = "We go to Maroko", MissionTypeId = 1, MissionType = new MissionType(), StartTime = DateTime.Now, EndTime = DateTime.Now  }); // nie dalem teamu i nie wiem co z missiontype 
            Missions.Add(new Mission() { Id = 2, Name = "Mission two", Description = "We go to India", MissionTypeId = 2, MissionType = new MissionType(), StartTime = DateTime.Now, EndTime = DateTime.Now }); // nie dalem teamu i nie wiem co z missiontype 
            ...
            Teams.Add(new Team() { Id = 1, Name = "Medics", TeamTypeId = 1, Responsibilities = "The are responsibility for soliders health." });
            Teams.Add(new Team() { Id = 2, Name = "Instructors", TeamTypeId = 2, Responsibilities = "The are responsibility training." });
